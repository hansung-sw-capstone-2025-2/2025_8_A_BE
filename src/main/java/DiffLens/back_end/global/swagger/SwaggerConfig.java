...
import DiffLens.back_end.global.responses.code.ErrorResponseDTO;
...
public class SwaggerConfig {
    ...
    @Bean
    public OpenAPI diffLensAPI() {

        Info info = new Info().title("DiffLens API").version("1.0.0");
